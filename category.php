        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 m-auto text-center">
                    <h1><?php echo $_GET['category_title']?></h1>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            ...
            <?php
               if(isset($_GET['category_id']) && isset($_GET['category_title'])){
                    ...
                    $stmt = mysqli_prepare($connection,"SELECT post_id,post_title,post_image,post_date,post_author,post_views FROM posts WHERE post_category_id=? ORDER BY post_id DESC");
                    mysqli_stmt_bind_param($stmt,'i',$category_id);
                    mysqli_stmt_execute($stmt);
                    mysqli_stmt_bind_result($stmt,$post_id,$post_title,$post_image,$post_date,$post_author,$post_views);
